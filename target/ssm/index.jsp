...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        ...
        <div class="item">
            <img src="images/105905-106.jpg" alt="第三张">
        </div>
...
<form method="post" action="loginServletRead">
<div class="panel panel-default" id="login">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" name="rdName" class="form-control" id="id" placeholder="请输入用户名">
        </div>
        <div class="form-group">
            <label for="passwd">密码</label>
            <input type="password" name="rdPwd" class="form-control" id="passwd" placeholder="请输入密码">
        </div>
